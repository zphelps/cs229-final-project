...
def main():
    ...
    # Create and train the Random Forest model with preprocessing
    ...
    print("\nPredicted vs Actual Podiums for Each Race (Random Forest):")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("\nCustom F1 Podium Prediction Metrics (Random Forest):")
